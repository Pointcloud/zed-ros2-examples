...
from launch.substitutions import ( #type: ignore
    LaunchConfiguration,
    TextSubstitution
)
...
def launch_setup(context, *args, **kwargs):
    ...
    # Params file for ZED camera
    config_persius_zed_params = os.path.join(
        get_package_share_directory('persius_bringup'),
        'config',
        'persius_zed_params.yaml'
    )
    ...
    zed_wrapper_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'ros_params_override_path': config_persius_zed_params
        }.items(),
